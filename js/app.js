...
function setPage(elem) {
  ...
  $( '.social-media-list li' ).first().children( 'img' ).attr('src', 'img/github-icon-small.png');
  ...
  if (content === 'Home') {
    ...
    $( '.social-media-list li' ).first().children( 'img' ).attr('src', 'img/github-icon-small-yellow.png');
